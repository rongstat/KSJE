...
#Gamma - a collecting of integers smaller than n1 and n2, being the index set of latent embedding. We recommend choosing Gamma=1:r where r is the desired latent dimension.
